...
public final class LdLinker extends AbstractLdLinker {
    ...
    private static final LdLinker dllLinker = new LdLinker(GccCCompiler.CMD_PREFIX + "ld",
            objFiles, discardFiles, "lib", ".so", false,
            new LdLinker(GccCCompiler.CMD_PREFIX + "ld", objFiles, discardFiles,
                    "lib", ".so", true, null));
    private static final LdLinker instance = new LdLinker(GccCCompiler.CMD_PREFIX + "ld",
