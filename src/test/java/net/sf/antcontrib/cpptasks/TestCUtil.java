...
import static net.sf.antcontrib.cpptasks.CUtil.parsePath;
...
public class TestCUtil {
    ...
    public void testGetPathFromEnvironment() {
        File[] files = getPathFromEnvironment("LIB", ";");
        assertNotNull(files);
    }
    ...
    public void testGetRelativePath1() throws IOException {
        ...
        String rel = getRelativePath(canonicalBase, new File("/foo/bar/baz"));
    ...
    public void testGetRelativePath2() throws IOException {
        String canonicalBase = new File("/foo/bar/").getCanonicalPath();
        String rel = getRelativePath(canonicalBase, new File("/foo/bar/"));
        assertEquals(".", rel);
    }
    ...
    public void testGetRelativePath3() throws IOException {
        String canonicalBase = new File("/foo/bar/").getCanonicalPath();
        String rel = getRelativePath(canonicalBase, new File("/foo/bar/a"));
        assertEquals("a", rel);
    }
    ...
    public void testGetRelativePath4() throws IOException {
        String canonicalBase = new File("/foo/bar/").getCanonicalPath();
        String rel = getRelativePath(canonicalBase, new File("/foo/"));
        assertEquals("..", rel);
    }
    ...
    public void testGetRelativePath5() throws IOException {
        String canonicalBase = new File("/foo/bar/").getCanonicalPath();
        String rel = getRelativePath(canonicalBase, new File("/a"));
    ...
    public void testGetRelativePath6() throws IOException {
        String canonicalBase = new File("/foo/bar/").getCanonicalPath();
        String rel = getRelativePath(canonicalBase, new File("/foo/baz/bar"));
    ...
    public void testGetRelativePath7() throws IOException {
        ...
        if (osName.contains("Windows")) {
            ...
            String rel = getRelativePath(canonicalBase, uncFile);
    ...
    public void testGetRelativePath8() throws IOException {
        ...
        String rel = getRelativePath(canonicalBase, new File("/foo/bar/something.extension"));
    ...
    public void testGetRelativePath9() throws IOException {
        String canonicalBase = new File("/foo/bar/something").getCanonicalPath();
        String rel = getRelativePath(canonicalBase, new File("/foo/bar/somethingElse"));
    ...
    public void testGetRelativePath10() throws IOException {
        String canonicalBase = new File("/foo/bar/something").getCanonicalPath();
        String rel = getRelativePath(canonicalBase, new File("/foo/bar/something else"));
    ...
    public void testParsePath2() {
        ...
        File[] files = parsePath(workingDir, ";");
    ...
    public void testParsePath4() {
        ...
        File[] files = parsePath(workingDir + ";" + javaHome, ";");
    ...
    public void testXmlEncode() {
        assertEquals("&lt;&quot;boo&quot;&gt;", xmlAttribEncode("<\"boo\">"));
    }
}
